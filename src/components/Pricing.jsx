...
export const Pricing = () => {
  return (
    <div>
      <div className="flex flex-col gap-4 items-center justify-center lg:ml-0 mt-10">
      ...
      <div className="lg:grid grid-cols-3 gap-24 flex flex-col justify-center items-center w-[1000px]">
